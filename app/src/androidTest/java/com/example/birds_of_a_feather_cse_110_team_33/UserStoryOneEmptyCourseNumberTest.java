...
public class UserStoryOneEmptyCourseNumberTest {
    ...
    public void userStoryOneEmptyCourseNumberTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.course_number_edit_text),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("167"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.course_number_edit_text), withText("167"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.course_edit_text), withText("CSE  Winter 2022"),
                        withParent(withParent(withId(R.id.parent_linear_layout))),
                        isDisplayed()));
        textView.check(matches(withText("CSE  Winter 2022")));
    }
